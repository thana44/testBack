...
router.post('/login', async(req, res)=>{
    try{
        ...
        res.cookie('acess_token', token, {secure:true,httpOnly:true,sameSite:'None',domain:'https://instasam-2p.netlify.app',path:'/',expires: theTime}).json({currentUser: userInDT})
        }
